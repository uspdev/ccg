            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="numtotcredisoptelt" name="numtotcredisoptelt" pattern="\d*"  
                        placeholder="Nº de créditos totais (aula + trabalho) exigidos em displinas optativas eletivas" type="text" required>
                </div>                
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="numtotcredisoptliv" name="numtotcredisoptliv"  pattern="\d*" 
                        placeholder="Nº de créditos totais (aula + trabalho) exigidos em displinas optativas livres" type="text" required>
                </div>                
                <div class="form-group">
