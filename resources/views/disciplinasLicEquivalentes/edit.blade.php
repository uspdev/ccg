...
@section('title', config('app.name') . ' - Currículo ' . $curriculo['id'] . 
    ' - Disciplinas Licenciaturas Equivalentes - ' . $disciplinaLicenciatura[0]['coddis'])

@section('content_header')
<h1>Curriculo {{ $curriculo['id'] }} - Editar Disciplina Licenciatura Equivalente - {{ $disciplinaLicenciatura[0]['coddis'] }}</h1>
@stop
...
@section('content')
    ...
    <div class="box box-primary">
        <form role="form" method="POST" action="/disciplinasLicEquivalentes/{{ $disciplinaLicenciaturaEquivalente[0]['id'] }}">
                        ...
                        <tr>
                            <th>
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="coddis" id="coddis" value="{{ $disciplinaLicenciaturaEquivalente[0]['coddis'] }}">
                                </div>                                        
                            </th>
                        </tr>                                                        
                    </thead>                            
